...
**ตอนนี้ข้อความ alert พ่วง guidance นี้มาให้แล้ว** — `signal_strategy_live.py`
จะต่อท้ายด้วยบรรทัด `📌 บริหารไม้: trailing stop 3×ATR (≈ …)` โดยอัตโนมัติ
(ปรับด้วย `--trail-atr K`, ใส่ `0` เพื่อซ่อน) ระยะ ≈ K×ATR(14) ของแท่งที่เกิดสัญญาณ
